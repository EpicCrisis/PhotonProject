...
namespace ExitGames
{
	namespace Chat
	{
		...
		bool Peer::opPublishMessage(const Common::JString& channelName, Ftype message)
		{
		...
		template<typename Ftype>
		bool Peer::opPublishMessage(const Common::JString& channelName, Ftype pMessageArray, typename Common::Helpers::ArrayLengthType<Ftype>::type arrSize)
		{
		...
		template<typename Ftype>
		bool Peer::opPublishMessage(const Common::JString& channelName, Ftype pMessageArray, const short* pArrSizes)
		{
		...
		template<typename Ftype>
		bool Peer::opSendPrivateMessage(const Common::JString& userName, Ftype message, bool encrypt)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG(!Common::Helpers::ConfirmAllowed<Ftype>::dimensions, ERROR_THIS_OVERLOAD_IS_ONLY_FOR_SINGLE_VALUES);
		...
		template<typename Ftype>
		bool Peer::opSendPrivateMessage(const Common::JString& userName, Ftype pMessageArray, typename Common::Helpers::ArrayLengthType<Ftype>::type arrSize, bool encrypt)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG(Common::Helpers::ConfirmAllowed<Ftype>::dimensions==1, ERROR_THIS_OVERLOAD_IS_ONLY_FOR_1D_ARRAYS);
		...
		template<typename Ftype>
		bool Peer::opSendPrivateMessage(const Common::JString& userName, Ftype pMessageArray, const short* pArrSizes, bool encrypt)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG((Common::Helpers::ConfirmAllowed<Ftype>::dimensions>1), ERROR_THIS_OVERLOAD_IS_ONLY_FOR_MULTIDIMENSIONAL_ARRAYS);
		...
		template<typename Ftype>
		bool Peer::opSetOnlineStatus(int status, Ftype message)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG(!Common::Helpers::ConfirmAllowed<Ftype>::dimensions, ERROR_THIS_OVERLOAD_IS_ONLY_FOR_SINGLE_VALUES);
		...
		template<typename Ftype>
		bool Peer::opSetOnlineStatus(int status, Ftype pMessageArray, typename Common::Helpers::ArrayLengthType<Ftype>::type arrSize)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG(Common::Helpers::ConfirmAllowed<Ftype>::dimensions==1, ERROR_THIS_OVERLOAD_IS_ONLY_FOR_1D_ARRAYS);
		...
		template<typename Ftype>
		bool Peer::opSetOnlineStatus(int status, Ftype pMessageArray, const short* pArrSizes)
		{
			COMPILE_TIME_ASSERT2_TRUE_MSG((Common::Helpers::ConfirmAllowed<Ftype>::dimensions>1), ERROR_THIS_OVERLOAD_IS_ONLY_FOR_MULTIDIMENSIONAL_ARRAYS);
