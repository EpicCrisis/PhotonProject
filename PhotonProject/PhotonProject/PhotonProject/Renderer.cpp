...
void Renderer::LoadPNG(const char* path, GLuint textureID, unsigned int& width, unsigned int& height)
{
...
void Renderer::LoadTexture(const char* fileName, GLuint textureID, unsigned int& width, unsigned int& height)
{
...
void Renderer::RenderGeometry(GLuint textureID, GLfloat* vertices, GLfloat* texCoords, GLubyte* colors)
{
...
void Renderer::RenderSquare(GLuint textureID, int x, int y, int width, int height, int depth, GLubyte r, GLubyte g, GLubyte b, GLubyte a, Vector2 minUV, Vector2 maxUV)
{
	...
	GLfloat* texCoords = UVRender::GetUV(minUV, maxUV);
	...
	RenderGeometry(textureID, vertices, texCoords, colors);
}

void Renderer::RenderSquare(GLuint textureID, int x, int y, int width, int height, int depth, GLubyte r, GLubyte g, GLubyte b, GLubyte a)
{
	RenderSquare(textureID, x, y, width, height, depth, r, g, b, a, Vector2(0.0, 1.0), Vector2(1.0, 0.0));
}

void Renderer::RenderSquare(GLuint textureID, int x, int y, int width, int height, int depth)
{
	RenderSquare(textureID, x, y, width, height, depth, 255, 255, 255, 255);
}