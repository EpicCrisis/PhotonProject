...
public:
	...
	virtual void updateRoomList(const ExitGames::Common::JString roomNames[], unsigned int size);
	virtual void updateSavedRoomList(const ExitGames::Common::JString savedRoomNames[], unsigned int size);
